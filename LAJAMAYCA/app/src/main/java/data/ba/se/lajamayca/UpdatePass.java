            ...
            public void onClick(View v) {
                ...
                if (cursor != null) {
                    ...
                    if (!oldpass.equals(xtrapass)){
                        ...
                        Toast.makeText(UpdatePass.this, "Please check your old password",Toast.LENGTH_LONG).show();
                }
                    else if (!newpass.equals(conpass)){
                        Toast.makeText(UpdatePass.this, "Please confirm your password",Toast.LENGTH_LONG).show();
                    }
                    else if (newpass.equals("")){
                        Toast.makeText(UpdatePass.this, "Please enter your password",Toast.LENGTH_LONG).show();
                    }
                    else {
                        db=openHelper.getWritableDatabase();
